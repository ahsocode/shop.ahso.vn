...
export default function HomePageClient() {
  ...
  return (
    <div ref={pageRef} className="bg-transparent text-slate-950">
      ...
      <section className="border-b border-slate-200 bg-white/78 backdrop-blur-[1px]">
      ...
      <section className="bg-white/78 py-16 backdrop-blur-[1px] sm:py-20">
      ...
      <section className="bg-slate-50/82 py-16 backdrop-blur-[1px] sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <section
        ...
        className="overflow-hidden bg-white/78 py-16 backdrop-blur-[1px] sm:py-20"
      >
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:min-h-[calc(100svh-4rem)] lg:grid-cols-[0.95fr_1.05fr] lg:items-center lg:px-8">
