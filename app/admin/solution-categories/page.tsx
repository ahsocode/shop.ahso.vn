...
export default function AdminSolutionCategoriesPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (form.id) {
        await patchJSON(`/api/admin/solution-categories/${form.id}`, payload);
        toast.success("Đã cập nhật danh mục");
      } else {
        await postJSON("/api/admin/solution-categories", payload);
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-semibold text-slate-900">Danh mục giải pháp</h1>
